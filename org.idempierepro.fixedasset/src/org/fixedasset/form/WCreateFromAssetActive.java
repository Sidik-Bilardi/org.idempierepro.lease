...
public class WCreateFromAssetActive extends CreateFromAssetActive implements EventListener<Event>, ValueChangeListener
{
	private WCreateFromWindow window;
	
	public WCreateFromAssetActive(GridTab tab) 
	{
		super(tab);
	...
	protected Label barcodeLabel = new Label();
	protected WStringEditor barcodeField = new WStringEditor();
	...
	public boolean dynInit() throws Exception
	{
		...
		barcodeField = new WStringEditor ("Barcode", false, false, true, 10, 30, null, null);
		barcodeField.getComponent().addEventListener(Events.ON_CHANGE, this);
	...
	protected void zkInit() throws Exception
	{
		...
		row = rows.newRow();
		row.appendChild(barcodeLabel.rightAlign());
		row.appendChild(barcodeField.getComponent());
	}
	...
	public void onEvent(Event e) throws Exception
	{
		...
		else if (e.getTarget().equals(barcodeField.getComponent())){
			Barcode = "";
			String bar = barcodeField.getDisplay();
			if (bar.length() > 1 ) Barcode = bar;
